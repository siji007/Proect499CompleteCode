                ...
                <ul class="-ml-8" style="list-style-type: none; " >
                    ...
                    <li v-for="attend in AttendPhysicalClass" :key="attend">
                        ...
                        <label v-bind:for="attend.id">
                            <input v-model="attendPhysicalClassRef" @input="$v.attendPhysicalClassRef.$touch()" class="" name="question24" type="radio" v-bind:value="attend.id" v-bind:id="attend.id">
                ...
                <ul class="-ml-8" style="list-style-type: none; " >
                    ...
                    <li v-for="read in ReadPhysicalBooks" :key="read">
                        ...
                        <label v-bind:for="read.id">
                            <input v-model="readPhysicalBooksRef" @input="$v.readPhysicalBooksRef.$touch()" class="" name="question25" type="radio" v-bind:value="read.id" v-bind:id="read.id">
